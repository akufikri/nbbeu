(() => {
          ...
          (e.exports = function (e) {
            ...
            function w() {
              (r = c && a.env("design")),
                (t = s.find(f)).length &&
                  (t.each(y),
                  a.env("preview") && !v && t.each(m),
                  g(),
                  a.redraw.on(i.redraw));
            }
            function g() {
            ...
            function m(t, r) {
              var a = e.data(r, f);
              a &&
                (a.links && a.links.each(h.reset),
                a.panes && a.panes.each(h.reset));
            }
            function y(t, a) {
              var n = f.substr(1) + "-" + t,
                i = e(a),
              ...
              if (
                  ...
                  o.links.on(
                    ...
                    function (e) {
                      ...
                      if (a in n) {
                        e.preventDefault();
                        var i = n[a];
                        -1 === i && (i = h.links.length - 1),
                          i === h.links.length && (i = 0);
                ...
                var s,
                  ...
                  b,
                  h,
                  v = o.links.filter("." + p).attr(u);
                v && k(o, { tab: v, immediate: !0 });
              }
            }
            function k(t, r) {
              r = r || {};
              ...
              if (l !== t.current) {
                ...
                n.focus(),
                  ...
                  g.length && i.outro
                    ? (g.each(h.outro),
                      o(g)
                        .add("opacity " + i.outro + "ms " + s, { fallback: d })
                        .start({ opacity: 0 })
                        .then(() => A(i, g, w)))
                    : A(i, g, w);
              }
    ...
    (() => {
      ...
      r.O = (t, a, n, i) => {
        ...
        for (var s = 1 / 0, o = 0; o < e.length; o++) {
          for (var [a, n, i] = e[o], l = !0, d = 0; d < a.length; d++)
            (!1 & i || s >= i) && Object.keys(r.O).every((e) => r.O[e](a[d]))
              ? a.splice(d--, 1)
              : ((l = !1), i < s && (s = i));
          if (l) {
            e.splice(o--, 1);
  ...
  var a = r.O(void 0, ["87", "238"], function () {
    return r(6223);
  });
  a = r.O(a);
})();
